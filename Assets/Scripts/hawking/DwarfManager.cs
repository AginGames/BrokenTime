...
public class dwarfmanager : MonoBehaviour, IData
{
    [SerializeField] private string id = "Hawking";
    public CinemachineVirtualCamera CameraNaPokoj;
    ...
    public GameObject hawkingCanvas;
    public Image image;
    ...
    void AppleCather()
    {
        ...
        CameraNaPokoj.Priority = 20;
        
        Cursor.visible = true;

        hawkingCanvas.SetActive(true);
    }
    public void Endthisshit()
    {
        hawkingCanvas.SetActive(false);
